...
export function CrearTipovidrio() {
  const urlBackendBase = import.meta.env.VITE_URL_BACKEND;
  const urlTipovidrio = `${urlBackendBase}tiposvidrios`;
  ...
  const crearTipovidrio = async (data) => {
    try {
      const respuesta = await axios.post(urlTipovidrio, data, { headers });
      exitoToast(
        `Se Creo el Tipo de Vidrio: ${respuesta.data.tipovidrio}`,
        false
      );
